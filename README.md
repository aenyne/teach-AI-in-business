...
| Andrew Barto and Richard S. Sutton | Reinforcement Learning: An Introduction (https://www.amazon.com/Reinforcement-Learning-Introduction-Richard-Sutton/dp/0262193981) | Reinforcement Learning is an aspect of Machine learning where an agent learns to behave in an environment, by performing certain actions and observing the rewards/results which it get from those actions. |
...
| Abhishek Vijyvagria| [Machine Learning with Python](https://www.amazon.in/Machine-Learning-Python-Abhishek-Vijayvargia/dp/9386551934/ref=asc_df_9386551934/?tag=googleshopdes-21&linkCode=df0&hvadid=397006811932&hvpos=&hvnetw=g&hvrand=17630569966686588381&hvpone=&hvptwo=&hvqmt=&hvdev=c&hvdvcmdl=&hvlocint=&hvlocphy=1007828&hvtargid=pla-934570075392&psc=1&ext_vrnc=hi) | This books basically starts with data science using python so it's a great resource for someone who already knows a little bit about python. It explains about different models in ML, taking you all the way through its application in real world. This book also covers aspects like Text Analysis, Neural Networks & DL with getting a little bit into Time Series Analysis. It says it's for beginners but i'd recommend it to someone who already knows what to expect, and what they are getting themselves into by entering into the field of Machine Learning |
